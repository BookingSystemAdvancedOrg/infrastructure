...
variable "role_arn" {
  description = "ARN of the GetMenuFn execution role (security/iam/get-menu)"
  type        = string
  sensitive   = true
}

variable "ecr_repository_url" {
  description = "Repository URL of the GetMenuFn ECR repository (storage/ecr/get-menu) — the repo itself is owned there, not created in this module"
  type        = string
  sensitive   = true
}
