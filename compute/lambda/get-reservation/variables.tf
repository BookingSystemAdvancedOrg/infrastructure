...
variable "role_arn" {
  description = "ARN of the GetReservationFn execution role (security/iam/get-reservation)"
  type        = string
  sensitive   = true
}

variable "ecr_repository_url" {
  description = "Repository URL of the GetReservationFn ECR repository (storage/ecr/get-reservation) — the repo itself is owned there, not created in this module"
  type        = string
  sensitive   = true
}
